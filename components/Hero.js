...
const Hero = ({ rightimage, paddingbottom, paddingbottomscreen, paddingtop, paddingtopscreen, bldisplay, beadcrumbdisplay, bannertitle, bannertitlespan, bannertitleright, bannermaxwidth, breadcrumb1, breadcrumb2, breadcrumb3, bannersideimagedisplay }) => {
  return (
            ...
            <div className="banner-left-start lg:w-[45%] relative before:'' before:absolute before:w-[198px] before:h-[4px] before:left-0 before:top-[-30px] before:bg-[#00233D] max-w-[470px] lg:max-w-[unset] mx-auto lg:mx-0">
              <div className="banner-left-above mb-[40px]">
                ...
                <div className="banner-text mb-[30px]">
                  <p className="mb-0  font-regular text-[18px] leading-[156%] text-[#2c2c2c]">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form.</p>
                </div>
                <div className="banner-btn">
                  <Link href="/" className="inline-flex justify-center item-center  font-extrabold text-[18px] leading-[150%] text-white bg-adt-orange hover:bg-adt-orange-600 border-[1px]  px-[42px] py-[14px]  hover:duration-300">
                    Get a Free Quote
                  </Link>
                </div>
              </div>
              ...
              <ul className={`banner-left-breadcrumb flex items-center flex-wrap mt-[50px] lg:mt-[110px] pb-[50px] ${beadcrumbdisplay} `}>
                ...
                <li>
                  <p href="/" className=" font-regular text-black text-[14px] leading-[120%] uppercase">
                    {breadcrumb3}
                  </p>
                </li>
              </ul>
