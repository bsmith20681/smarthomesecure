...
import Equip2 from "@/public/images/equip-img-2.png";
import Equip3 from "@/public/images/equip-img-3.png";
import Equip4 from "@/public/images/equip-img-4.png";
      ...
      <div className="container">
        <div className="equip-section pt-[80px] pb-[30px]">
          <div className="pricing-title mb-[30px]">
            <h2 className="font-manrope font-extrabold text-adt-blue-dark text-[34px] lg:text-[40px] xl:text-[50px] leading-[120%] max-w-[85%]">ADT Security Equipments</h2>
          </div>
          <div className="equip-slider-start">
            <Slider {...settings} className="equip-slider">
                ...
                <div className="equip-slide-inside h-full flex flex-col justify-between items-center">
                  ...
                  <div className="equip-slide-below max-w-[220px] mx-auto">
                    ...
                    <div className="equip-slide-text text-center mb-[25px]">
                      <p className="font-manrope font-regular text-special-grey text-[18px] leading-[155%]">Protect yourself with the best security camera</p>
                    </div>
              ...
              <div className="equip-slide w-full h-full pt-[30px] pb-[46px] px-[40px] bg-white shadow-[0_0_10px_0_rgba(0,0,0,0.1)]">
                <div className="equip-slide-inside h-full flex flex-col justify-between items-center">
                  ...
                  <div className="equip-slide-below max-w-[240px] mx-auto">
                    <div className="equip-slide-title text-center mb-[6px]">
                      <h2 className="font-manrope font-extrabold text-[20px] text-adt-blue-dark leading-[150%]">Smart Home Security</h2>
                    </div>
                    <div className="equip-slide-text text-center mb-[25px]">
                      <p className="font-manrope font-regular text-special-grey text-[18px] leading-[155%]">Smart security for a home with no worries</p>
                    </div>
                    <div className="group equip-slide-link inline-flex justify-center items-center font-manrope font-bold text-special-light-blue text-[14px] leading-[120%] hover:duration-300 hover:opacity-70 cursor-pointer relative left-[50%] translate-x-[-50%]">
                      <span>Read More</span>
                      <PlayIcon />
              ...
              <div className="equip-slide w-full h-full pt-[30px] pb-[46px] bg-white shadow-[0_0_10px_0_rgba(0,0,0,0.1)]">
                <div className="equip-slide-inside h-full flex flex-col justify-between items-center">
                  <div className="equip-slide-above h-full">
                    <div className="equip-slide-img flex justify-center items-center relative left-[-35px] mb-[10px] height-minus-30">
                      <Image src={Equip3} alt="img" className="w-[300px] md:w-[auto] max-w-full" />
                    </div>
                  </div>
                  <div className="equip-slide-below max-w-[220px] mx-auto">
                    <div className="equip-slide-title text-center mb-[6px]">
                      <h2 className="font-manrope font-extrabold text-[20px] text-adt-blue-dark leading-[150%]">Life Safety Detectors</h2>
                    </div>
                    <div className="equip-slide-text text-center mb-[25px]">
                      <p className="font-manrope font-regular text-special-grey text-[18px] leading-[155%]">Peace of mind for everything you love</p>
                    </div>
                    <div className="group equip-slide-link inline-flex justify-center items-center font-manrope font-bold text-special-light-blue text-[14px] leading-[120%] hover:duration-300 hover:opacity-70 cursor-pointer relative left-[50%] translate-x-[-50%]">
                      <span>Read More</span>
                      <PlayIcon />
              ...
              <div className="equip-slide w-full h-full pt-[30px] pb-[46px] bg-white shadow-[0_0_10px_0_rgba(0,0,0,0.1)]">
                <div className="equip-slide-inside h-full flex flex-col justify-between items-center">
                  <div className="equip-slide-above ml-[20px] h-full">
                    <div className="equip-slide-img flex justify-center items-center mb-[10px] height-minus-30">
                      <Image src={Equip4} alt="img" className="w-[300px] md:w-[auto] max-w-full" />
                    </div>
                  </div>
                  <div className="equip-slide-below max-w-[260px] mx-auto">
                    <div className="equip-slide-title text-center mb-[6px]">
                      <h2 className="font-manrope font-extrabold text-[20px] text-adt-blue-dark leading-[150%]">Smart Home Automation</h2>
                    </div>
                    <div className="equip-slide-text text-center mb-[25px]">
                      <p className="font-manrope font-regular text-special-grey text-[18px] leading-[155%]">Turn your house into an ADT smart home</p>
                    </div>
                    <div className="group equip-slide-link inline-flex justify-center items-center font-manrope font-bold text-special-light-blue text-[14px] leading-[120%] hover:duration-300 hover:opacity-70 cursor-pointer relative left-[50%] translate-x-[-50%]">
                      <span>Read More</span>
                      <PlayIcon />
